...
goog.addDependency(bp + 'io/nfg/wmg/battle/BattleLogic.js', ['io.nfg.wmg.battle.BattleLogic'], ['io.nfg.core.Pos', 'io.nfg.core.Tools', 'io.nfg.wmg.battle.CombatsLogic', 'io.nfg.wmg.battle.EntityFactory', 'io.nfg.wmg.battle.Mechanics', 'io.nfg.wmg.battle.SpecialsLogic', 'io.nfg.wmg.battle.SpellsLogic', 'io.nfg.wmg.battle.StatusesLogic', 'io.nfg.wmg.battle.components.UnitData', 'io.nfg.wmg.battle.helpers.BattleHelper', 'io.nfg.wmg.battle.helpers.StatusHelper', 'io.nfg.wmg.battle.helpers.UnitHelper', 'io.nfg.wmg.battle.modes.AGameMode', 'io.nfg.wmg.battle.modes.Annihilation', 'io.nfg.wmg.battle.modes.Assassination', 'io.nfg.wmg.battle.modes.RoundAttack', 'io.nfg.wmg.battle.modes.RunAway', 'io.nfg.wmg.battle.modes.StayAlive', 'io.nfg.wmg.models.Actor', 'io.nfg.wmg.models.DeckUnit', 'io.nfg.wmg.models.Map', 'io.nfg.wmg.models.Mission', 'io.nfg.wmg.models.PlayerTypes', 'io.nfg.wmg.models.SpecialTile', 'org.incubatio.Entity', 'org.incubatio.TileMap', 'org.apache.royale.utils.Language']);
goog.addDependency(bp + 'io/nfg/wmg/models/Mission.js', ['io.nfg.wmg.models.Mission'], ['io.nfg.core.db.AModel', 'io.nfg.wmg.models.Actor', 'io.nfg.wmg.models.DeckUnit', 'io.nfg.wmg.models.Map', 'io.nfg.wmg.models.PlayerTypes']);
goog.addDependency(bp + 'io/nfg/wmg/models/Map.js', ['io.nfg.wmg.models.Map'], ['io.nfg.core.db.AModel']);
...
goog.addDependency(bp + 'io/nfg/wmg/battle/SpellsLogic.js', ['io.nfg.wmg.battle.SpellsLogic'], ['io.nfg.core.Pos', 'io.nfg.core.Tools', 'io.nfg.wmg.battle.BattleLogic', 'io.nfg.wmg.battle.Mechanics', 'io.nfg.wmg.battle.components.UnitData', 'io.nfg.wmg.battle.helpers.StatusHelper', 'io.nfg.wmg.battle.helpers.UnitHelper', 'io.nfg.wmg.utils.Resources', 'org.incubatio.Entity']);
...
goog.addDependency(bp + 'io/nfg/wmg/battle/components/UnitData.js', ['io.nfg.wmg.battle.components.UnitData'], ['io.nfg.core.Pos', 'io.nfg.core.db.AModel', 'io.nfg.wmg.models.DeckUnit', 'org.incubatio.core.AComponent']);
...
goog.addDependency(bp + 'org/apache/royale/utils/Language.js', ['org.apache.royale.utils.Language'], ['goog.DEBUG', 'org.apache.royale.utils.Language']);
